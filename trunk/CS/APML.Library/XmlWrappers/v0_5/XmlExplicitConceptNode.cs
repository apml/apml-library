...
namespace APML.XmlWrappers.v0_5 {
  public class XmlExplicitConceptNode : XmlAttentionNodeBase<IExplicitConcept>, IExplicitConcept {
    public XmlExplicitConceptNode(APMLFileBase pFile, XmlNode pNode) : base(pFile, pNode) {
    }

    #region IExplicitConcept Members
